          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                  Make your first income with our masterclass
                </Heading>
                <Text as="p">
                  We are a team of top student consultants who are experts in their field. providing you with the best step by step guide to land your first freelancing contract
                </Text>
              </Box>
