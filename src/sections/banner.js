        ...
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            ...
            <Box as="form" sx={styles.form}>
              ...
              /> */}
              <Button sx={styles.form.button} onClick={(event) => { event.preventDefault(); window.open('https://forms.gle/ED6Ky9H74jWDCbPz6')}}>
                Register
              </Button>
              {/* <Link
            path="https://forms.gle/ED6Ky9H74jWDCbPz6"
            ml={2}
            label="Register Now"
          ...
          /> */}
            ...
            {/* <Box sx={styles.partner}>
              ...
              <Box as="div">
                <Img loading="lazy" src={img1} width="100" height="28" alt="" />
              </Box>
              <Box as="div">
                <Img loading="lazy" width="85" height="28" src={img2} alt="" />
              </Box>
              <Box as="div">
                <Img loading="lazy" width="123" height="24" src={img3} alt="" />
              </Box>
            </Box> */}
          </Box>
          <Box sx={styles.image}>
