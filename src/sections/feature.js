...
const FeatureData = [
  {
    image: featureImage1,
    title: 'How to build a profile on upwork.com',
    comments: 'Coming soon',
    path: '/',
  },
  {
    image: featureImage2,
    title: 'How to get high paying tech clients',
    comments: 'Coming soon',
    path: '/',
  },
  {
    image: featureImage3,
    title:
      'How to be a graphic design freelancer?',
    comments: 'Coming soon',
    path: '/',
  },
];
...
const Feature = () => {
  ...
  return (
    <Box sx={styles.features} id="news">
      <Container>
        <BlockTitle
          slogan="Upskill Courses"
          title="Tutorials that people need most"
