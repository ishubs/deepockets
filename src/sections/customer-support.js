        ...
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              <Heading as="h3">
                Free Student Support to ensure what you like to expect
              </Heading>
              <Text as="p">
                We offer you the best in class rare to find practical knowledge with exact step by step process of execution. If you are unsatisfied, we’ll refund payment or fix
                issues on our dime period customers.
              </Text>
              <Text as="p" sx={styles.specialText}>
                If you are happy with the process and wish to continue. If you
