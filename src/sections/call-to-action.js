  ...
  return (
    <Box sx={styles.wrapper}>
      <Container sx={styles.container}>
        <Box sx={styles.inner}>
          <Heading as="h3">
            Learn the secrets to making money as a student<br />
            from one of the top freelancers
          </Heading>
          <Box sx={styles.btnWrapper}>
            <Button onClick={()=>window.open('https://forms.gle/iXU33xwjQ22ZA6SQ8')}  sx={styles.btn}>Register Now</Button>
          </Box>
        </Box>
      </Container>
    </Box>
